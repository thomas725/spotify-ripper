...
class WebAPI(object):
    ...
    def request_json(self, url, msg):
        ...
        try:
            ...
            print(Fore.YELLOW + "URL returned non-200 HTTP code: " + str(e.http_status) + " message: " + e.msg + Fore.RESET)
            return None
        return res
    ...
    def request_url(self, url, msg):
        ...
        if res.status_code == 200:
            ...
            print(Fore.YELLOW + "URL returned non-200 HTTP code: " + str(res.status_code) + Fore.RESET)
        return None
    ...
    def get_charts(self, uri):
        ...
        def get_chart_tracks(metrics, region, time_window, from_date):
            url = self.charts_url(metrics + "/" + region + "/" + time_window + "/" + from_date + "/download")
        ...
        valid_regions = {
            "us", "gb", "ad", "ar", "at", "au", "be", "bg", "bo", "br", "ca", "ch", "cl", "co", "cr", "cy", "cz", "de", "dk", "do", "ec", "ee", "es", "fi", "fr", "gr", "gt", "hk", "hn", "hu", "id", "ie", "is", "it", "lt", "lu", "lv", "mt",
            "mx", "my", "ni", "nl", "no", "nz", "pa", "pe", "ph", "pl", "pt", "py", "se", "sg", "sk", "sv", "tr", "tw", "uy", "global"
        }
        ...
        charts_obj = {"metrics": uri_tokens[2], "region": uri_tokens[3], "time_window": uri_tokens[4], "from_date": uri_tokens[5], "tracks": tracks_obj}
